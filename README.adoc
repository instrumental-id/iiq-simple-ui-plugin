...
Instrumental Identity sells a commercial product, the link:https://instrumentalidentity.com/software-2/id-iq-plugins/ui-enhancer-plugin/[IIQ UI Enhancer Plugin], which provides this functionality and vastly more. This plugin was also demonstrated during the DevDays talk.
